...
class Diagnostics:
    ...
    def failure(self, code, exit_code=None, error=None):
        ...
        return f'CCMA se detuvo en {labels[self.stage]}: {reason}. {result} Referencia: {self.reference} · {safe}. Requiere revisión; no repitas la consulta todavía.'
