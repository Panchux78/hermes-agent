...
try:
    ...
    KeyboardButton = ReplyKeyboardMarkup = Any
...
def check_telegram_requirements() -> bool:
    ...
    global KeyboardButton, ReplyKeyboardMarkup
    ...
    try:
        ...
        KeyboardButton, ReplyKeyboardMarkup = _tg.KeyboardButton, _tg.ReplyKeyboardMarkup
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Accounting flows require PTB, unlike importing the optional adapter.
        ...
        self._portal_iva_flow = PortalIvaFlow(**portal_kwargs)
    ...
    def _rich_payload_base(self, chat_id: str, content: str) -> Dict[str, Any]:
        ...
        payload["reply_markup"] = self._persistent_menu_reply_markup()
    ...
    async def _handle_callback_query(self, update: "Update", context: "ContextTypes.DEFAULT_TYPE") -> None:
        ...
        if data.startswith("oa:") or data == "om:administracion":
            ...
            if await self._admin_maintenance_flow.callback(
                self, query, data, cb["chat_id"], cb["thread_id"], str(getattr(query.from_user, "id", ""))
            ):
                return
        ...
        if data.startswith("ps:"):
            ...
            if not self._is_callback_user_authorized(
                ...
                await query.answer(text="⛔ No estás autorizado para procesar documentos.")
                return
            if await self._pdf_security_flow.callback(
        ...
        if data == "hg:restart":
            ...
            try:
                if cb["chat_id"] is not None:
                    await self._bot.send_message(
                        chat_id=normalize_telegram_chat_id(str(cb["chat_id"])),
    ...
    async def _send_local_file(
        ...
        try:
            ...
            remote_filename = getattr(getattr(msg, "document", None), "file_name", None) if media_key == "document" else None
            return SendResult(
                success=True, message_id=str(msg.message_id),
